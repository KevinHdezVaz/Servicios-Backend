 ...
 <li><a href="import.php" class="menu-item">Import Product</a>
        ...
        <li class="has-sub nav-item"><a href="#"><i class="ft-clock"></i><span data-i18n="" class="menu-title">Timeslot</span></a>
         ...
         <li class="has-sub nav-item"><a href="#"><i class="ft-image"></i><span data-i18n="" class="menu-title">Banner</span></a>
			  ...
			  <li class="has-sub nav-item"><a href="#"><i class="ft-compass"></i><span data-i18n="" class="menu-title">Flash</span></a>
                <ul class="menu-content">
                  <li><a href="flash.php" class="menu-item">Add Flash sale</a>
                  </li>
                  <li><a href="flashlist.php" class="menu-item">List Flash Sale</a>
                  </li>
			  ...
			  <li class="has-sub nav-item"><a href="#"><i class="ft-compass"></i><span data-i18n="" class="menu-title">Flash Item</span></a>
                <ul class="menu-content">
                  <li><a href="flashitem.php" class="menu-item">Add Flash  Item </a>
                  </li>
                  <li><a href="flashitemlist.php" class="menu-item">List Flash  Item</a>
                  </li>
