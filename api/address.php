...
else 
{
	...
	if($aid == 0)
	{
 	$con->query("insert into address(`uid`,`hno`,`society`,`pincode`,`area`,`landmark`,`type`,`name`,`latitud`,`longitud`,`municipio`) values(" . $uid . ",'" . $hno . "','" . $society . "'," . $pincode . ",'" . $area . "','" . $landmark . "','" . $type . "','" . $name . "', " . $latitud . ", " . $longitud . ", " . $municipio . ")");
