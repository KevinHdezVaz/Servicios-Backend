						...
						<form class="form" method="post" enctype="multipart/form-data">
							<div class="form-body">
                               ...
                               <div class="form-group">
								...
								<div class="form-group">
									<label for="gurl">Max Quantity</label>
									<input type="number" id="gurl" class="form-control"  placeholder="Enter Max Quantity For Order" value="<?php echo $selk['mqty'];?>" name="mqty" required>
								...
								<div class="form-group">
									<label for="gurl">Flash Sale Price</label>
									<input type="text" id="fprice" class="form-control"  value="<?php echo str_replace('$;',',',$selk['fprice']);?>" name="fprice" data-role="tagsinput" required>
									<p>After  write Product Price Press Enter</p>
								</div>
...
$popular = $_POST['popular'];
       $discount = $_POST['discount_percentage'];
		...
		$fprice = str_replace(',','$;',$_POST['fprice']);
...
else 
{
	...
	$arr[] = "product/".$file_name;
        ...
        $con->query("update product set mqty=".$mqty.",fprice='".$fprice."',pname='".$pname."',sname='".$sname."',pimg='".$pimg."',prel='".$related."',popular=".$popular.",discount=".$discount.",cid=".$catname.",sid=".$subcatname.",psdesc='".$psdesc."',pgms='".$pgms."',pprice='".$pprice."',status=".$status.",stock=".$ostock." where id=".$_GET['edit']."");
					...
					<div class="px-3">
						<form class="form" action="#" method="post" enctype="multipart/form-data">
							<div class="form-body">
								...
								<div class="form-group">
									<label for="gurl">Max Quantity</label>
									<input type="number" id="gurl" class="form-control"  placeholder="Enter Max Quantity For Order"  name="mqty" required>
								...
								<div class="form-group">
									<label for="gurl">Flash Sale Price</label>
									<input type="text" id="fprice" class="form-control"  value="1,10" name="fprice" data-role="tagsinput" required>
									<p>After  write Product Price Press Enter</p>
								</div>
...
else 
{
	...
	$arr[] = "product/".$file_name;
		...
		$con->query("insert into product(`mqty`,`pname`,`pimg`,`prel`,`sname`,`cid`,`sid`,`psdesc`,`pgms`,`pprice`,`date`,`status`,`stock`,`discount`,`popular`,`fprice`)values(".$mqty.",'".$pname."','".$url."','".$related."','".$sname."',".$catname.",".$subcatname.",'".$psdesc."','".$pgms."','".$pprice."','".$timestamp."',".$status.",".$ostock.",".$discount.",".$popular.",'".$fprice."')");
